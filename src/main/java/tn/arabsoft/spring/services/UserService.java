...
public class UserService {
  ...
  public void sendVerificationEmail(User user,String siteUrl)throws AddressException, MessagingException, IOException{
	  Properties props = new Properties();
	   ...
	   Session session = Session.getInstance(props, new javax.mail.Authenticator() {
	      protected PasswordAuthentication getPasswordAuthentication() {
	         return new PasswordAuthentication("unideva454@gmail.com", "pehtcqiubuzbgieu");
	      }
	   });
	  ...
	  mailContent +="<h3><a href=\""+lien+"\"> Verify</a> </h3>";
	   mailContent +="<p> Thank you<br> ArabsoftGroup </p>";
	   Message msg = new MimeMessage(session);
	   msg.setFrom(new InternetAddress("unideva454@gmail.com", false));
...
public Page<User> getAllUsers(PageRequest pr,String recherche){
  ...
  public  List<User> getAllUsersByroleName(){
	  ...
	  adminUser.setUserFName("achref");
	  adminUser.setUserLName("jlidi");
	  adminUser.setUserName("achrefjlidi");
	  adminUser.setEmail("fakhreddine.abessi@esprit.tn");
	  adminUser.setPassword(getEncodedPassword("achref123"));
  ...
  public void updateResetPassword (String token , String email) {
  	...
  	public void updatePassword (User user,String newPassword){
  	 ...
  	 public void sendResetPasswordnEmail(String email,String  resetPasswordLink)throws AddressException, MessagingException, IOException{
  		 ...
  		 // mailContent +="<h3><a href=\""+lien+"\"> Verify</a> </h3>";
  		   mailContent +="<p> Thank you<br> arabsoft </p>";
  		   Message msg = new MimeMessage(session);
  		   msg.setFrom(new InternetAddress("unideva454@gmail.com", "arabsoft"));
